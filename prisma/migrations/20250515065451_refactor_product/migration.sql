...
-- DropForeignKey
ALTER TABLE "_SkusVariantOptions" DROP CONSTRAINT "_SkusVariantOptions_A_fkey";

-- DropForeignKey
ALTER TABLE "_SkusVariantOptions" DROP CONSTRAINT "_SkusVariantOptions_B_fkey";
...
-- DropTable
DROP TABLE "_SkusVariantOptions";
...
create unique index "SKU_productId_sku_value_unique" on "SKU"("productId","value") where 'deletedAt' is null;